...
public class PageFault {
     ...
     * to find the proper page while making sure that ber is
     * not exceeded.
     * <pre>
     *   Page page = ( Page ) mem.get( oldestPage )
     * </pre>
     ...
     * @param virtualPageNumber is the number of virtual pages in the
     ...
     */
    public static void replacePage (List<Page> mem , int virtualPageNumber , int replacePageNum , ControlPanel controlPanel )
    {
        ...
        while ( ! (mapped) || count != virtualPageNumber ) {
